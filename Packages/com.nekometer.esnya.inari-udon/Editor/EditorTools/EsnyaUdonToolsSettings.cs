...
namespace InariUdon.EditorTools
{
    ...
    {
        public const string SettingsPath = "ProjectSettings/InariUdon.json";
        ...
        private static InariUdonSettings instance;
        public static InariUdonSettings Instance
        {
            get
            {
                if (!instance)
                {
                    instance = CreateInstance<InariUdonSettings>();
